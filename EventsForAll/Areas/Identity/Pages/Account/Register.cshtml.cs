...
namespace EventsForAll.Areas.Identity.Pages.Account
{
    [AllowAnonymous]
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Required]
            [StringLength(100, ErrorMessage = "{0} трябва да е минимум {2} и максимум {1} сумвола дълъг.", MinimumLength = 6)]
