        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ModifiedOn = table.Column<DateTime>(nullable: true),
                    Name = table.Column<string>(nullable: true),
                    EventCategoryId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ChildEventCategories", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventSchedule = table.Column<string>(nullable: true),
                    ...
                    ChildEventCategoryId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Events_ChildEventCategories_ChildEventCategoryId",
                        column: x => x.ChildEventCategoryId,
                        principalTable: "ChildEventCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChildEventCategories_EventCategoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_ChildEventCategoryId",
                table: "Events",
                column: "ChildEventCategoryId");
